...
namespace SpreadsheetTester
{
    ...
    public class GradingTests
    {
        ...
        public void Verify(AbstractSpreadsheet sheet, params object[] constraints)
        {
        ...
        public void OneFormula(AbstractSpreadsheet ss)
        {
            ...
            Set(ss, "B1", "5.2");
            Set(ss, "C1", "= A1+B1");
            Verify(ss, "A1", 4.1, "B1", 5.2, "C1", 9.3);
        }
        ...
        public void Formulas(AbstractSpreadsheet ss)
        {
            ...
            Set(ss, "E1", "= A1 * B1");
            Set(ss, "F1", "= A1 / B1");
            Verify(ss, "C1", 6.6, "D1", 2.2, "E1", 4.4 * 2.2, "F1", 2.0);
        }
        ...
        public void SaveTest7()
        {
            ...
            Verify(ss, "A1", "hello", "A2", 5.0, "A3", 4.0, "A4", 9.0);
        }
        ...
        public void Formula1(AbstractSpreadsheet ss)
        {
            ...
            Set(ss, "b1", "2.0");
            Set(ss, "b2", "3.0");
            Verify(ss, "a1", 10.0, "a2", 5.0);
            Set(ss, "b2", "4.0");
            Verify(ss, "a1", 11.0, "a2", 6.0);
        }
        ...
        public void Formula2(AbstractSpreadsheet ss)
        {
            ...
            Set(ss, "a2", "= a3");
            Set(ss, "a3", "6.0");
            Verify(ss, "a1", 12.0, "a2", 6.0, "a3", 6.0);
            Set(ss, "a3", "5.0");
            Verify(ss, "a1", 10.0, "a2", 5.0, "a3", 5.0);
        }
        ...
        public void MediumSheet(AbstractSpreadsheet ss)
        {
            ...
            Set(ss, "B2", "= A3 * A4");
            Set(ss, "C1", "= B1 + B2");
            Verify(ss, "A1", 1.0, "A2", 2.0, "A3", 3.0, "A4", 4.0, "B1", 3.0, "B2", 12.0, "C1", 15.0);
            Set(ss, "A1", "2.0");
            Verify(ss, "A1", 2.0, "A2", 2.0, "A3", 3.0, "A4", 4.0, "B1", 4.0, "B2", 12.0, "C1", 16.0);
            Set(ss, "B1", "= A1 / A2");
            Verify(ss, "A1", 2.0, "A2", 2.0, "A3", 3.0, "A4", 4.0, "B1", 1.0, "B2", 12.0, "C1", 13.0);
        }
